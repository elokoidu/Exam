...
<div class="error">
    ...
    <div class="error__description">Tundub et selle leheni ei ole veel jõutud</div>
    <a href="/home"><button class="error__button error__button--active">Avalehele</button></a>
</div>
